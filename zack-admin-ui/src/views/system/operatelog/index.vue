...
import {OperateLogPageReqVO, OperateLogPageRespVO} from "@/api/system/operatelog/types.ts";
import {page} from "@/api/system/operatelog";
import OperateLogDetails from "@/views/system/operatelog/OperateLogDetails.vue";
...
const queryParams: Ref<OperateLogPageReqVO> = ref({
...
const pageListData = ref<OperateLogPageRespVO[]>([])
...
<template>
    <div class="login-log-container">
        <el-row>
            ...
            <el-col :xs="24" :sm="16" :md="19" :lg="20" :xl="20">
                <el-form ref="userFormRef" :model="queryParams" class="demo-form-inline" :inline="true">
                    <el-form-item label="操作状态" prop="result" style="width: 240px">
                        <el-select
                                placeholder="请选择操作结果"
                    ...
                    <el-form-item label="模块名" prop="module">
                        <el-input v-model="queryParams.module" placeholder="请输入模块名" style="width: 240px"/>
                    </el-form-item>

                    <el-form-item label="操作类型" prop="type" style="width: 240px">
                        <el-select
                            placeholder="请选择操作类型"
                        ...
                        >
                            <el-option
                                v-for="item in getDictDataByDictType(DICT_TYPE.SYSTEM_OPERATE_TYPE)"
                                :key="item.value"
                                :label="item.label"
                                :value="item.value"
                            />
                    ...
                    <el-form-item>
                        <el-button v-hasPermission="['system:operate-log:query']" class="button-global"
                ...
                <el-row>
                    <el-button class="button-global" v-hasPermission="['system:operate-log:export']"
                ...
                <el-table table-layout="fixed" :data="pageListData" size="small" style="width: 100%">
                    ...
                    <el-table-column prop="type" label="操作类型">
                        <template #default="scope">
                            <dict-tag :type="DICT_TYPE.SYSTEM_OPERATE_TYPE" :value="String(scope.row.type)"/>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column label="操作" width="160" align="center">
                        <template #default="scope">
                            <el-button size="small" type="primary"
                                       v-hasPermission="['system:operate-log:query']" @click="openDetails(scope.row.id)">详情
                            </el-button>
                        </template>
                    </el-table-column>
                </el-table>
        ...
        <OperateLogDetails ref="detailsRef"/>
    </div>
</template>
