...
import {getCodeApi, reqCheckApi} from '../../../../api/login/index.ts'
...
const getPictrue = async () => {
    ...
    if (resp.repCode == '0000') {
        ...
        // console.log("backImg => ", backImgBase.value)
        // console.log("blockBackImgBase => ", blockBackImgBase.value)
    } else {
        tipWords.value = resp.repMsg
    }
};
</script>
