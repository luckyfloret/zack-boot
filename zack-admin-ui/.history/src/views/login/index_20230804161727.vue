        ...
        <el-row :gutter="10" class="box1">
            <el-col :xs="0" :sm="12" :md="12" :lg="14" :xl="14"
                ...
                <div>
                    ...
                    <img style="width: 100%" src="../../../../src/assets/login-cover.png" alt="">
                </div>
            </el-col>
            <el-col :xs="24" :sm="12" :md="12" :lg="10" :xl="10" class="login-right-container">
                ...
                >
                    ...
                    <el-form-item label="用户名" prop="username" style="width: 320px">
                        <el-input v-model="ruleForm.username" type="username" autocomplete="off" style="height: 35px"/>
                    </el-form-item>
                    <el-form-item label="密码" prop="password" style="width: 320px">
                        <el-input v-model="ruleForm.password" type="password" autocomplete="off" style="height: 35px"/>
                    </el-form-item>
                    <el-form-item>
...
import useAuthUserStore from "@/store/module/auth.ts";
