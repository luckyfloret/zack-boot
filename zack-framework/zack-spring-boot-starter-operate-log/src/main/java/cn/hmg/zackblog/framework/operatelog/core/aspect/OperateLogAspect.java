...
public class OperateLogAspect {
    ...
    private void recordLog(OperateLog operateLog, ProceedingJoinPoint joinPoint, Object result, LocalDateTime operateTime, Throwable exception) {
        ...
        cn.hmg.zackblog.framework.operatelog.pojo.OperateLog operateLogEntity = new cn.hmg.zackblog.framework.operatelog.pojo.OperateLog();
    ...
    private void setRequestInfo(cn.hmg.zackblog.framework.operatelog.pojo.OperateLog operateLogEntity) {
    ...
    private void setUserInfo(cn.hmg.zackblog.framework.operatelog.pojo.OperateLog operateLogEntity) {
    ...
    private void setResultInfo(cn.hmg.zackblog.framework.operatelog.pojo.OperateLog operateLogEntity, Object result, Throwable exception, OperateLog operateLog) {
        //设置成功结果
    ...
    private void setSuccessResultInfo(cn.hmg.zackblog.framework.operatelog.pojo.OperateLog operateLogEntity, Object result, OperateLog operateLog) {
    ...
    private void setMethodInfo(ProceedingJoinPoint joinPoint, cn.hmg.zackblog.framework.operatelog.pojo.OperateLog operateLogEntity, OperateLog operateLog) {
    ...
    private void setOperateLogAnnotationInfo(cn.hmg.zackblog.framework.operatelog.pojo.OperateLog operateLogEntity, ProceedingJoinPoint joinPoint, OperateLog operateLog) {
    ...
    private void setExceptionResultInfo(cn.hmg.zackblog.framework.operatelog.pojo.OperateLog operateLogEntity, Throwable exception) {
        //记录异常信息
        if (exception instanceof ServiceException) {
            log.info("exception => {}", ((ServiceException) exception).getCode());
            ServiceException serviceException = (ServiceException) exception;
            //手动设置异常信息，因为如果是java内部异常是无法转换异常信息的，例如算数异常
            operateLogEntity.setResultCode(serviceException.getCode());
            operateLogEntity.setResultMsg(serviceException.getMessage());
            return;
        }
